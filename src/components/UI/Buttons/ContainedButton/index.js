...
const useStyles = makeStyles(theme => ({
  ...
  root: props => ({
    ...
    '&:hover': {
      boxShadow: 'none',
      backgroundColor: props.backgroundColor ? props.backgroundColor : `${theme.palette.error.dark}`,
  ...
  "@keyframes shine": props => ({
    '0%': { left: '200%' },
    '100%': { left: '-200%' }
  })
}));

const ContainedButton = ({ className, type, backgroundColor, color, variant = 'contained', disabled, loading, children, ...rest }) => {
