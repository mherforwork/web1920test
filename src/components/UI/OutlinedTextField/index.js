...
const useStyles = makeStyles(theme => ({
  textField: props => ({
    border: props.readOnly ? `1px solid ${theme.palette.secondary.contrastText}80` : `1px solid ${theme.custom.palette.textInputBorder}`,
  ...
  adornmentButton: {
    backgroundColor: theme.palette.background.uiMain,
    height: '30px',
    maxWidth: '73px',
            ...
            type === 'password' ? (
              <InputAdornment className={classes.inputAdornment} position='end'>
                <IconButton
                  ...
                  {showPassword ?
                    <Button component='div' className={classes.adornmentButton}>
